...
def test_annotation_to_gtf_basic_conversion() -> None:
    ...
    annotations = [
        {
            'seqid': 'chr1', 'source': '.', 'feature': 'exon',
            'start': 1, 'end': 100, 'score': '.', 'strand': '+',
            'frame': '.', 'attribute': 'gene_id "gene1";'
        },
        {
            'seqid': 'chr2', 'source': 'source', 'feature': 'gene',
            'start': 200, 'end': 300, 'score': '0.5', 'strand': '-',
            'frame': '0', 'attribute': 'gene_id "gene2";'
        }
    ]
    expected = [
