...
def test_check_data_anomalies_skips_primary_key_columns() -> None:
    """
...
def test_check_data_anomalies_outlier_detection_sqlite_limitation() -> None:
    """
...
def test_find_duplicate_rows_multiple_duplicate_groups() -> None:
    """
...
def test_find_unused_columns_mixed_usage() -> None:
    """
