...
def test_compare_table_data_different_row_counts(dual_engines: tuple[Engine, Engine]) -> None:
    """
...
def test_compare_table_data_invalid_source_connection_type_error(memory_engine: Engine) -> None:
    """
...
def test_compare_table_data_invalid_target_connection_type_error(memory_engine: Engine) -> None:
    """
...
def test_compare_table_data_invalid_source_table_type_error(memory_engine: Engine) -> None:
    """
...
def test_compare_table_data_empty_source_table_value_error(memory_engine: Engine) -> None:
    """
...
def test_compare_table_data_invalid_compare_columns_type_error(memory_engine: Engine) -> None:
    """
...
def test_compare_table_data_invalid_sample_differences_type_error(memory_engine: Engine) -> None:
    """
...
def test_compare_table_data_negative_sample_differences_value_error(memory_engine: Engine) -> None:
    """
