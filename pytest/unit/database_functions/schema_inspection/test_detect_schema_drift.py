...
from conftest import Base, Product, User
...
from pyutils_collection.database_functions import detect_schema_drift
...
def test_detect_schema_drift_missing_tables(
    memory_engine: Engine, schema_dict: dict
) -> None:
    """
...
def test_detect_schema_drift_multiple_diffs(
    memory_engine: Engine, schema_dict: dict
) -> None:
    """
...
def test_detect_schema_drift_invalid_expected_schema_type(
