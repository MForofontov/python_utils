...
import pytest
import numpy as np
from scientific_computing_functions.statistical_analysis.bootstrap_statistic import (
    bootstrap_statistic,
)
...
def test_bootstrap_statistic_mean_default() -> None:
    ...
    # Act
    result = bootstrap_statistic(data, statistic='mean', n_iterations=1000, random_seed=42)
...
def test_bootstrap_statistic_median() -> None:
    ...
    # Act
    result = bootstrap_statistic(data, statistic='median', n_iterations=1000, random_seed=42)
...
def test_bootstrap_statistic_std() -> None:
    ...
    # Act
    result = bootstrap_statistic(data, statistic='std', n_iterations=1000, random_seed=42)
...
def test_bootstrap_statistic_numpy_array() -> None:
    ...
    assert all(key in result for key in ['point_estimate', 'ci_lower', 'ci_upper', 'standard_error'])
...
def test_bootstrap_statistic_different_confidence_level() -> None:
    ...
    # Act
    result_95 = bootstrap_statistic(data, confidence_level=0.95, n_iterations=1000, random_seed=42)
    result_99 = bootstrap_statistic(data, confidence_level=0.99, n_iterations=1000, random_seed=42)
