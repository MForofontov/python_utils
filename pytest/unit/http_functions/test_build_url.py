...
def test_build_url_with_empty_scheme():
    """
    Test build_url function with empty scheme raises ValueError.
    """
...
def test_build_url_with_whitespace_scheme():
    """
    Test build_url function with whitespace-only scheme raises ValueError.
    """
    with pytest.raises(ValueError, match="Scheme must be a non-empty string"):
        build_url("   ", "example.com")
...
def test_build_url_with_none_scheme():
    """
    Test build_url function with None scheme raises TypeError.
    """
...
def test_build_url_with_empty_hostname():
    """
    Test build_url function with empty hostname raises ValueError.
    """
...
def test_build_url_with_whitespace_hostname():
    """
    Test build_url function with whitespace-only hostname raises ValueError.
    """
    with pytest.raises(ValueError, match="Hostname must be a non-empty string"):
        build_url("https", "   ")
...
def test_build_url_with_none_hostname():
    """
    Test build_url function with None hostname raises TypeError.
    """
    with pytest.raises(TypeError):
...
def test_build_url_simple():
    """
    Test build_url function with basic scheme and hostname.
    """
...
def test_build_url_with_path():
    """
    Test build_url function with path component.
    """
...
def test_build_url_with_port():
    """
    Test build_url function with port number.
    """
...
def test_build_url_with_port_and_path():
    """
    Test build_url function with both port and path.
    """
...
def test_build_url_with_single_query_param():
    """
    Test build_url function with single query parameter.
    """
...
def test_build_url_with_multiple_query_params():
    """
    Test build_url function with multiple query parameters.
    """
...
def test_build_url_with_fragment():
    """
    Test build_url function with fragment component.
    """
...
def test_build_url_with_username():
    """
    Test build_url function with username only.
    """
...
def test_build_url_with_username_and_password():
    """
    Test build_url function with username and password.
    """
...
def test_build_url_complex_all_components():
    """
    Test build_url function with all components present.
    """
...
def test_build_url_http_scheme():
    """
    Test build_url function with HTTP scheme.
    """
...
def test_build_url_with_ip_address():
    """
    Test build_url function with IP address as hostname.
    """
...
def test_build_url_with_subdomain():
    """
    Test build_url function with subdomain hostname.
    """
...
def test_build_url_empty_path():
    """
    Test build_url function with empty path string.
    """
...
def test_build_url_empty_query_params():
    """
    Test build_url function with empty query parameters dict.
    """
...
def test_build_url_none_query_params():
    """
    Test build_url function with None query parameters.
    """
...
def test_build_url_none_fragment():
    """
    Test build_url function with None fragment.
    """
...
def test_build_url_empty_fragment():
    """
    Test build_url function with empty fragment string.
    """
...
def test_build_url_special_characters_in_query():
    """
    Test build_url function properly encodes special characters in query params.
    """
