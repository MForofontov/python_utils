...
from pyutils_collection.iterable_functions.list_comparison.partially_contains_sublist import (
...
def test_partially_contains_sublist_success() -> None:
    """
    Test case 1: Test the partially_contains_sublist function with valid inputs.
    """
...
def test_partially_contains_sublist_not_found() -> None:
    """
    Test case 2: Test the partially_contains_sublist function with main_list not found.
    """
    main_list: list[str] = ["a", "b"]
...
def test_partially_contains_sublist_empty_main_list() -> None:
    """
    Test case 3: Test the partially_contains_sublist function with an empty main_list.
    """
    main_list: list[str] = []
    list_of_lists: list[list[str]] = [["a", "b", "c"], ["d", "e"]]
    expected_output: bool = False
...
def test_partially_contains_sublist_empty_list_of_lists() -> None:
    """
    Test case 4: Test the partially_contains_sublist function with an empty list_of_lists.
    """
    main_list: list[str] = ["a", "b"]
...
def test_partially_contains_sublist_integers() -> None:
    """
    Test case 5: Test the partially_contains_sublist function with lists of integers.
    """
...
def test_partially_contains_sublist_mixed_types() -> None:
    """
    Test case 6: Test the partially_contains_sublist function with mixed types.
    """
...
def test_partially_contains_sublist_type_error_main_list() -> None:
    """
    Test case 7: Test the partially_contains_sublist function with invalid type for main_list.
    """
...
def test_partially_contains_sublist_type_error_list_of_lists() -> None:
    """
    Test case 8: Test the partially_contains_sublist function with invalid type for list_of_lists.
    """
    with pytest.raises(TypeError):
...
def test_partially_contains_sublist_type_error_elements() -> None:
    """
    Test case 9: Test the partially_contains_sublist function with invalid elements in list_of_lists.
    """
    with pytest.raises(TypeError):
