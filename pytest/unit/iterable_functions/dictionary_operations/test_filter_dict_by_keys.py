...
from iterable_functions.dictionary_operations.filter_dict_by_keys import filter_dict_by_keys
...
def test_filter_dict_by_keys_case_1_exact_key_matches() -> None:
    ...
    """
    # Arrange
    input_data: dict[str, Any] = {'name': 'John', 'age': 30, 'city': 'NYC', 'email': 'john@example.com'}
