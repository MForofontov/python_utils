...
try:
    import paramiko
    from pyutils_collection.ssh_functions.remote.ssh_check_connection import ssh_check_connection
...
def test_ssh_check_connection_successful_with_password() -> None:
    ...
    """
    with patch(
        "pyutils_collection.ssh_functions.remote.ssh_check_connection.paramiko.SSHClient"
    ) as mock_client:
        with patch(
            "pyutils_collection.ssh_functions.remote.ssh_check_connection.getpass.getuser",
