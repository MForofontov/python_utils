...
import pytest
from serialization_functions.csv_advanced.transform_csv_columns import transform_csv_columns
...
def test_transform_csv_columns_invalid_column_selection() -> None:
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        with pytest.raises(ValueError, match="not found in output columns"):
            transform_csv_columns(input_file, output_file, select_columns=['nonexistent'])
