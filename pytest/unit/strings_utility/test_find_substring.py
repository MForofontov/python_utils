...
from python_utils.strings_utility.find_substring import find_substring
...
def test_substring_not_present() -> None:
    ...
    """
    assert find_substring("hello world", "there") == -1, (
...
def test_special_characters() -> None:
    ...
    """
    assert find_substring("hello!@# world", "!@#") == 5, (
...
def test_numbers() -> None:
    ...
    """
    assert find_substring("hello123 world", "123") == 5, (
...
def test_leading_trailing_spaces() -> None:
    ...
    """
    assert find_substring("  hello world  ", "hello") == 2, (
...
def test_non_english_characters() -> None:
    ...
    """
    assert find_substring("héllo wörld", "wörld") == 6, (
