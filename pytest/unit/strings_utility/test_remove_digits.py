...
from pyutils_collection.strings_utility.remove_digits import remove_digits
...
def test_remove_digits_basic() -> None:
    ...
    """
    assert remove_digits("hello123") == "hello", (
...
def test_remove_digits_special_characters() -> None:
    ...
    """
    assert remove_digits("hello!@#123") == "hello!@#", (
...
def test_remove_digits_non_english_characters() -> None:
    ...
    """
    assert remove_digits("héllo123") == "héllo", (
...
def test_remove_digits_digits_at_start() -> None:
    ...
    """
    assert remove_digits("123hello") == "hello", (
...
def test_remove_digits_digits_in_middle() -> None:
    ...
    """
    assert remove_digits("he123llo") == "hello", (
