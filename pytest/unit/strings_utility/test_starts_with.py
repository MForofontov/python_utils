...
from python_utils.strings_utility.starts_with import starts_with
...
def test_starts_with_basic_true() -> None:
    ...
    """
    assert starts_with("hello world", "hello"), "Failed on basic true case"
...
def test_starts_with_basic_false() -> None:
    ...
    """
    assert not starts_with("hello world", "world"), "Failed on basic false case"
...
def test_starts_with_empty_string() -> None:
    ...
    """
    assert not starts_with("", "hello"), "Failed on empty string"
...
def test_starts_with_empty_prefix() -> None:
    ...
    """
    assert starts_with("hello world", ""), "Failed on empty prefix"
...
def test_starts_with_both_empty() -> None:
    ...
    """
    assert starts_with("", ""), "Failed on both string and prefix being empty"
...
def test_starts_with_special_characters() -> None:
    ...
    """
    assert starts_with("!@#hello", "!@#"), "Failed on special characters"
...
def test_starts_with_numbers() -> None:
    ...
    """
    assert starts_with("12345hello", "12345"), "Failed on numbers"
...
def test_starts_with_mixed_case_true() -> None:
    ...
    """
    assert starts_with("HelloWorld", "Hello"), "Failed on mixed case true"
...
def test_starts_with_mixed_case_false() -> None:
    ...
    """
    assert not starts_with("HelloWorld", "hello"), "Failed on mixed case false"
...
def test_starts_with_whitespace_characters() -> None:
    ...
    """
    assert starts_with("   hello", "   "), "Failed on whitespace characters"
...
def test_starts_with_tab_characters() -> None:
    ...
    """
    assert starts_with("\thello", "\t"), "Failed on tab characters"
