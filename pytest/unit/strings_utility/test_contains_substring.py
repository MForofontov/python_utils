...
def test_contains_substring_not_present() -> None:
    ...
    """
    assert (
        contains_substring("hello world", "there") == False
...
def test_contains_substring_both_empty() -> None:
    ...
    ), "Failed on both string and substring empty"
...
def test_contains_substring_beginning() -> None:
    ...
    """
    assert (
        contains_substring("hello world", "hello") == True
...
def test_contains_substring_end() -> None:
    ...
    assert (
        contains_substring("hello world", "world") == True
    ), "Failed on substring at the end"
...
def test_contains_substring_middle() -> None:
    ...
    """
    assert (
        contains_substring("hello world", "lo wo") == True
...
def test_contains_substring_single_character_present() -> None:
    ...
    """
    assert (
        contains_substring("hello world", "o") == True
    ), "Failed on single character present"
...
def test_contains_substring_single_character_not_present() -> None:
    ...
    """
    assert (
        contains_substring("hello world", "x") == False
...
def test_contains_substring_numbers() -> None:
    ...
    """
    assert (
        contains_substring("hello123 world", "123") == True
...
def test_contains_substring_mixed_case() -> None:
    ...
    """
    assert (
        contains_substring("Hello World", "world") == False
...
def test_contains_substring_spaces() -> None:
    ...
    assert (
        contains_substring("hello world", " ") == True
    ), "Failed on substring with spaces"
...
def test_contains_substring_non_english_characters() -> None:
    ...
    """
    assert (
        contains_substring("héllo wörld", "wörld") == True
