...
from pyutils_collection.strings_utility.ends_with import ends_with
...
def test_string_ends_with_suffix() -> None:
    ...
    """
    assert ends_with("hello world", "world"), "Failed on string ending with suffix"
...
def test_suffix_is_entire_string() -> None:
    ...
    """
    assert ends_with("hello", "hello"), "Failed on suffix being the entire string"
...
def test_empty_suffix() -> None:
    ...
    """
    assert ends_with("hello", ""), "Failed on empty suffix"
...
def test_empty_string_and_non_empty_suffix() -> None:
    ...
    """
    assert not ends_with("", "hello"), "Failed on empty string and non-empty suffix"
...
def test_both_string_and_suffix_are_empty() -> None:
    ...
    """
    assert ends_with("", ""), "Failed on both string and suffix being empty"
...
def test_suffix_longer_than_string() -> None:
    ...
    """
    assert not ends_with("hello", "hello world"), "Failed on suffix longer than string"
...
def test_string_ends_with_space() -> None:
    ...
    """
    assert ends_with("hello world ", " "), "Failed on string ending with a space"
...
def test_string_does_not_end_with_space() -> None:
    ...
    """
    assert not ends_with("hello world", " "), "Failed on string not ending with a space"
...
def test_string_ends_with_digit() -> None:
    ...
    """
    assert ends_with("hello world 123", "123"), "Failed on string ending with a digit"
