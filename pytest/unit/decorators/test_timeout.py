...
def test_timeout_exceeded():
    ...
    with pytest.raises(TimeoutException, match="Function long_running_function timed out after 1 seconds"):
...
def test_timeout_with_logger(caplog):
    ...
    with caplog.at_level(logging.ERROR):
        ...
        assert "Function long_running_function_with_logger timed out after 1 seconds" in caplog.text
