...
def test_multi_decorator_with_variable_length_arguments(caplog: pytest.LogCaptureFixture) -> None:
    """
    ...
    assert result == "decorator1(decorator2(args: (1, 2, 3), kwargs: {'kwarg1': 'test', 'kwarg2': 'example'}))"

def test_multi_decorator_function_raises_error(caplog: pytest.LogCaptureFixture) -> None:
    """
