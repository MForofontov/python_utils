...
def test_format_file_size_bytes() -> None:
    """
    Test case 1: Format bytes without unit conversion.
    """
    # Arrange & Act & Assert
...
def test_format_file_size_binary_units() -> None:
    """
    Test case 2: Format with binary units (1024-based).
    """
    # Arrange & Act & Assert
...
def test_format_file_size_decimal_units() -> None:
    """
    Test case 3: Format with decimal units (1000-based).
    """
    # Arrange & Act & Assert
...
def test_format_file_size_precision() -> None:
    """
    Test case 4: Test different precision values.
    """
    # Arrange
    size = 1536
...
def test_format_file_size_invalid_type_size_bytes() -> None:
    """
    Test case 7: TypeError for invalid size_bytes type.
    """
    # Arrange
    invalid_input = "1024"
...
def test_format_file_size_invalid_type_binary() -> None:
    """
    Test case 8: TypeError for invalid binary type.
    """
    # Arrange
...
def test_format_file_size_invalid_type_precision() -> None:
    """
    Test case 9: TypeError for invalid precision type.
    """
    # Arrange
...
def test_format_file_size_negative_size() -> None:
    """
    Test case 10: ValueError for negative size.
    """
    # Arrange
...
def test_format_file_size_negative_precision() -> None:
    """
    Test case 11: ValueError for negative precision.
    """
    # Arrange
...
def test_format_file_size_boundary_values() -> None:
    """
    Test case 12: Test boundary values between units.
    """
    # Arrange & Act & Assert
