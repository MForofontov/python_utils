...
def test_format_duration_zero() -> None:
    """
    Test case 1: Format zero seconds.
    """
    # Arrange & Act & Assert
...
def test_format_duration_seconds_only() -> None:
    """
    Test case 2: Format durations less than a minute.
    """
    # Arrange & Act & Assert
...
def test_format_duration_minutes() -> None:
    """
    Test case 3: Format durations with minutes.
    """
    # Arrange & Act & Assert
...
def test_format_duration_precision_1() -> None:
    """
    Test case 8: Test precision=1 (single unit).
    """
    # Arrange & Act & Assert
...
def test_format_duration_precision_3() -> None:
    """
    Test case 9: Test precision=3 (three units).
    """
    # Arrange & Act & Assert
    assert format_duration(90061, precision=3) == "1d 1h 1m"
...
def test_format_duration_long_format_pluralization() -> None:
    """
    Test case 11: Verify correct pluralization in long format.
    """
    # Arrange & Act & Assert
    assert format_duration(1, long_format=True) == "1 second"
...
def test_format_duration_invalid_type_seconds() -> None:
    """
    Test case 12: TypeError for non-numeric seconds.
    """
    # Arrange
...
def test_format_duration_invalid_type_precision() -> None:
    """
    Test case 13: TypeError for invalid precision type.
    """
    # Arrange
...
def test_format_duration_invalid_type_long_format() -> None:
    """
    Test case 14: TypeError for invalid long_format type.
    """
    # Arrange
...
def test_format_duration_negative_seconds() -> None:
    """
    Test case 15: ValueError for negative seconds.
    """
    # Arrange
...
def test_format_duration_invalid_precision() -> None:
    """
    Test case 16: ValueError for invalid precision value.
    """
    # Arrange
...
def test_format_duration_large_values() -> None:
    """
    Test case 17: Format very large durations.
    """
    # Arrange & Act & Assert
    # 10 years
