...
def test_get_days_in_month_january() -> None:
    ...
    """
    result: int = get_days_in_month(date_obj=None, year=2023, month=1)
...
def test_get_days_in_month_february_non_leap() -> None:
    ...
    """
    result: int = get_days_in_month(date_obj=None, year=2023, month=2)
    assert isinstance(result, int)
    assert result == 28
...
def test_get_days_in_month_february_leap() -> None:
    ...
    """
    result: int = get_days_in_month(date_obj=None, year=2020, month=2)
    assert isinstance(result, int)
    assert result == 29
...
def test_get_days_in_month_april() -> None:
    ...
    """
    result: int = get_days_in_month(date_obj=None, year=2023, month=4)
    assert isinstance(result, int)
    assert result == 30
...
def test_get_days_in_month_december() -> None:
    ...
    """
    result: int = get_days_in_month(date_obj=None, year=2023, month=12)
    assert isinstance(result, int)
    assert result == 31
...
def test_get_days_in_month_all_months() -> None:
    ...
    for month, expected in enumerate(expected_days, 1):
        result: int = get_days_in_month(date_obj=None, year=2023, month=month)
...
def test_get_days_in_month_all_months_leap() -> None:
    ...
    for month, expected in enumerate(expected_days, 1):
        result: int = get_days_in_month(date_obj=None, year=2020, month=month)
        assert result == expected
...
def test_get_days_in_month_from_date_object() -> None:
    ...
    result: int = get_days_in_month(date_obj=test_date)
    assert isinstance(result, int)
...
def test_get_days_in_month_invalid_month() -> None:
    ...
    with pytest.raises(ValueError):
        get_days_in_month(date_obj=None, year=2023, month=0)

    with pytest.raises(ValueError):
        get_days_in_month(date_obj=None, year=2023, month=13)

    with pytest.raises(ValueError):
        get_days_in_month(date_obj=None, year=2023, month=-1)
...
def test_get_days_in_month_invalid_input_type() -> None:
    ...
    with pytest.raises(ValueError):
        get_days_in_month(date_obj=None, year=None, month=1)

    with pytest.raises(ValueError):
        get_days_in_month(date_obj=None, year=2023, month=None)

    with pytest.raises(TypeError):
        get_days_in_month(date_obj="not_a_date")
