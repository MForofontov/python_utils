...
from pyutils_collection.testing_functions.fixture_factories.create_temp_dir_fixture import (
...
def test_create_temp_dir_fixture_with_subdirectories() -> None:
    ...
    """
    # Arrange
    files = {"dir1/file1.txt": "content1", "dir2/file2.txt": "content2"}
...
def test_create_temp_dir_fixture_nested_directories() -> None:
    ...
    """
    # Arrange
    files = {"level1/level2/level3/file.txt": "deep content"}
